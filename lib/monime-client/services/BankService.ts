...
export class BankService {
     ...
     * @param country ISO 3166-1 alpha-2 country code (e.g., 'SL', 'GH') to filter banks by region.
     ...
     * @param providerId Unique provider ID for the bank as assigned by Monime.
     * @param monimeVersion Specifies which version of the Monime API will handle this request.
     * @returns any OK
     * @throws ApiError
     */
